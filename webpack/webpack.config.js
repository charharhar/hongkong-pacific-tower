...
function configFactory() {
  ...
  let webpackConfig = {
    ...
    entry: {
      ...
      leasing: removeEmpty([
        ifDev('webpack-hot-middleware/client'),
        path.resolve(appRootDir.get(), './public/js/leasing')
      ]),
      about: removeEmpty([
        ifDev('webpack-hot-middleware/client'),
        path.resolve(appRootDir.get(), './public/js/about')
      ]),
      innovative: removeEmpty([
        ifDev('webpack-hot-middleware/client'),
        path.resolve(appRootDir.get(), './public/js/innovative')
      ]),
      downloads: removeEmpty([
        ifDev('webpack-hot-middleware/client'),
        path.resolve(appRootDir.get(), './public/js/downloads')
      ]),
      contact: removeEmpty([
        ifDev('webpack-hot-middleware/client'),
